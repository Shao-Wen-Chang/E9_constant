...
T = 0.8             # (fundamental) temperature (k_B * T)
...
# boson specific
nu_b = 5/6               # filling factor (1 is one particle per site)
Np_b = int(V * nu_b)        # number of bosons

step_pot_exp = E9M.DoS_exp(T, [
    {"name": "fermion", "V": V, "Np": Np_f, "stat": "fermi", "DoS": DoS_exp,
        "E_range": E_range_exp, "reservoir": "", "comment": {}},
    {"name": "boson", "V": V, "Np": Np_b, "stat": "bose", "DoS": DoS_exp,
        "E_range": E_range_exp, "reservoir": "", "comment": {}},
])
